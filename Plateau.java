...
/**
 *
 * La classe Plateau sert à répresenter un plateau de jeu (le placement des pions). 
 * 
 * <p>C'est à dire ensemble de cellules (pions) qui consituent le damier.
...
class Plateau implements Serializable {
    ...
    public boolean estPlein(){  // on verifie si le plateau est plein
        boolean plain = true;
    ...
    public boolean estTermine() {
        return this.estPlein() || this.estGagne(Puis4.JOUEUR) || this.estGagne(Puis4.PROG);
    }
